...
@WebServlet("/UserSideinquiryFormController")
public class UserSideinquiryFormController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (isError == true) {
			...
			RequestDispatcher rd = request.getRequestDispatcher("UserSideContactUs.jsp");
